...
MUSDB_WAV_INPUT_PATH = project_root_path / "sample_data" / "musdb18hq"
print("INPUT PATH: ")
print(MUSDB_WAV_INPUT_PATH)

# Output paths (can be the same as the original convert script)
SPECTROGRAM_OUTPUT_PATH = project_root_path / "sample_data" / "spectrograms2"
WAVEFORM_OUTPUT_PATH = project_root_path / "sample_data" / "waveforms2"

# Spectrogram parameters (reuse from original script if desired)
N_MELS = 128
N_FFT = 2048
HOP_LENGTH = 512
CHUNK_DURATION_SECONDS = 15.0 # Duration of each chunk in seconds
